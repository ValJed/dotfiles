...
# Pass
config.bind('<ctrl+shift+f>', 'spawn --userscript qute-pass -U secret -u "login: (.+)" -d rofi -dmenu')

# config.bind('ctrl-j', 'selection-down')
# config.bind('ctrl-k', 'selection-up')
...
# Type: Bool
config.set('content.local_content_can_access_remote_urls', True, 'file:///home/jed/.local/share/qutebrowser/userscripts/*')

# Allow locally loaded documents to access other local URLs.
# Type: Bool
config.set('content.local_content_can_access_file_urls', False, 'file:///home/jed/.local/share/qutebrowser/userscripts/*')
