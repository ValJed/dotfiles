return {
	{
		...
		config = function()
			...
			wk.add({
				...
				{ "<leader>gD", ":lua require('git.diff').open()<cr>", desc = "Git Diff" },
				{ "<leader>gD", ":lua require('git.diff').close()<cr>", desc = "Git Diff Close" },
				{ "<leader>gO", ":lua require('git.browse').pull_request()<cr>", desc = "Open Pull Request" },
				{ "<leader>gP", ":lua require('git.browse').create_pull_request()<cr>", desc = "Create Pull Request" },
				...
				{ "<leader>1", ":lua require('harpoon'):list():select(1)<cr>", hidden = true },
				{ "<leader>2", ":lua require('harpoon'):list():select(2)<cr>", hidden = true },
				{ "<leader>3", ":lua require('harpoon'):list():select(3)<cr>", hidden = true },
				{ "<leader>4", ":lua require('harpoon'):list():select(4)<cr>", hidden = true },
				{ "<leader>5", ":lua require('harpoon'):list():select(5)<cr>", hidden = true },
				{ "<leader>6", ":lua require('harpoon'):list():select(6)<cr>", hidden = true },
				{ "<leader>7", ":lua require('harpoon'):list():select(7)<cr>", hidden = true },
				{ "<leader>8", ":lua require('harpoon'):list():select(8)<cr>", hidden = true },
				{ "<leader>9", ":lua require('harpoon'):list():select(9)<cr>", hidden = true },
