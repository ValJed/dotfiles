      ...
      keyboards = {
        default = {
          ...
          config = ''
            ...
            (defalias
              caps-word (caps-word-toggle 2000)
            ...
            (deflayer base
              @caps-word  1       2     3    4    5    6    7    8       9       0        -      =    bspc    ;; 14
              tab         q       w     e    r    t    y    u    i       o       p        \      ]    ret     ;; 14
              esc         a       s     d    f    g    h    j    k       l       ;        '       bspc    ;; 13
              @media      @z_alt  x     c    v    b    n    m    ,       .       @/_alt   rsft    ;; 12
              lctl        lalt    lmet       @spc_mod            @media  ralt    rctl     ;; 7
            )

            (deflayer special
              @caps-word   f1   f2   f3   f4   f5   f6    f7    f8   f9   f10  f11   f12    _
              grv          1    2    3    4    5    6     7     8    9    0    =     S-=    ret
              esc          S-1  S-2  S-3  S-4  S-5  AG-6  S-9   S-0  S-7  S-8  S-7   bspc
              @media       S-`  S-=  =    [    ]    AG-`  S-[   S-]  -    S--        rsft
            ...
            (deflayer media
              ...
              esc          S-prtsc    C-b     voldwn     volu    _      left     down     up     rght   _       _    _
              @media       C-S-prtsc  _       next prev  next    _      C-S-tab  C-tab    _      _      _
