        ...
        default = {
          ...
          config = ''
            ...
            (deflayer base
              ...
              lsft  z    x      c    v    b    n    m    ,    .     @/_alt  rsft    ;; 12
              lctl  lmet lalt             @spc_mod            ralt  rmet    rctl    ;; 7
            )
            ...
            (deflayer media
              ...
              _          prtsc      _     _          pp      _      home   pgdn   pgup   end    C-S-v   _    _   ret
              _          S-prtsc    mute  voldwn     volu    _      left   down   up     rght   _       _    _
